...
_C.MODEL.ROI_RELATION_HEAD.SQUAT_MODULE.BETA = 1.0 

_C.MODEL.ROI_RELATION_HEAD.SQUAT_MODULE.RHO = 1.0 

_C.MODEL.ROI_RELATION_HEAD.SQUAT_MODULE.SLOW_MASK_PREDICTOR = True 

_C.MODEL.ROI_RELATION_HEAD.SQUAT_MODULE.PRETRAIN_MASK = True

_C.MODEL.ROI_RELATION_HEAD.SQUAT_MODULE.PRETRAIN_MASK_ITER = 2000 

_C.MODEL.ROI_RELATION_HEAD.SQUAT_MODULE.NUM_DECODER = 3

_C.MODEL.ROI_RELATION_HEAD.SQUAT_MODULE.PRE_NORM = False

_C.MODEL.ROI_RELATION_HEAD.SQUAT_MODULE.GRAPH_HIDDEN_DIM = 512

_C.MODEL.ROI_RELATION_HEAD.SQUAT_MODULE.LOSS_COEF = 1.
